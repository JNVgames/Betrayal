...
public class JobDescription {
    ...
    public static String getWarriorDescription() { return warriorDescription; }
    public static String getKnightDescription() { return knightDescription; }
    public static String getPriestDescription() { return priestDescription; }
    public static String getThiefDescription() { return thiefDescription; }
}
