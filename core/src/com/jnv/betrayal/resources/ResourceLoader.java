...
//				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(190).attack(88).defense(16)
		...
		new Monster.MonsterFactory()
				...
				.health(180).attack(92).defense(27)
		...
		new Monster.MonsterFactory()
				...
				.health(170).attack(20).defense(0)
		...
		new Monster.MonsterFactory()
				...
				.health(250).attack(77).defense(18)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(7500)
				.numTargets(2).effectCooldown(3)
				.effect(new Heal(150))
