...
//				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(34).attack(32).defense(28)
		...
		new Monster.MonsterFactory()
				...
				.health(10).attack(40).defense(200)
		...
		new Monster.MonsterFactory()
				...
				.health(30).attack(15).defense(15)
				.goldReward(400)
				.numTargets(1)
				.build();
		new Monster.MonsterFactory()
				...
				.health(30).attack(14).defense(50)
				.goldReward(400)
				.numTargets(1)
				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(38).defense(12)
		...
		new Monster.MonsterFactory()
				...
				.health(45).attack(37).defense(17)
		...
		new Monster.MonsterFactory()
				...
				.health(78).attack(36).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.textureName("monster-tier2-5").skillTextureName("monstershieldbreak")
				.health(90).attack(42).defense(8)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1000)
				.numTargets(1).effectCooldown(3)
				.effect(new DefenseDown(40, 2)).effectCooldown(4)
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(18)
				...
				.health(28).attack(28).defense(98)
		...
		new Monster.MonsterFactory()
				...
				.health(33).attack(69).defense(69)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(44).defense(21)
				.textureWidth(400).textureHeight(500).x(160).y(670)
				.goldReward(900)
				.numTargets(1).effectCooldown(3)
		...
		new Monster.MonsterFactory()
				...
				.health(30).attack(20).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(36).attack(77).defense(51)
		...
		new Monster.MonsterFactory()
				...
				.id(27)
				.nickname("Ghost")
				.textureName("monster-tier3-3").skillTextureName("monstermelee")
				.health(100).attack(50).defense(0)
		...
		new Monster.MonsterFactory()
				...
				.health(48).attack(57).defense(20)
		...
		new Monster.MonsterFactory()
				...
				.health(80).attack(80).defense(18)
		...
		new Monster.MonsterFactory()
				...
				.textureName("monster-tier3-7").skillTextureName("monsterblock")
				.health(40).attack(10).defense(10)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1500)
				.numTargets(1).effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(200).attack(20).defense(50)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1200)
				.numTargets(1)
				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(51).defense(10)
		...
		new Monster.MonsterFactory()
				...
				.health(120).attack(10).defense(10)
		...
		new Monster.MonsterFactory()
				...
				.health(72).attack(64).defense(32)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3200)
				.numTargets(1).effectCooldown(3)
				.build();
		new Monster.MonsterFactory()
				...
				.health(75).attack(50).defense(10)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3700)
				.numTargets(1).effectCooldown(3)
				.effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(42).attack(26).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(27).attack(37).defense(52)
		...
		new Monster.MonsterFactory()
				...
				.health(24).attack(47).defense(400)
		...
		new Monster.MonsterFactory()
				...
				.health(31).attack(32).defense(40)
		...
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(53)
				.nickname("Jeff the Killer")	.health(25).attack(45).defense(0)
				.health(25).attack(10).defense(1)
		...
		new Monster.MonsterFactory()
				...
				.health(50).attack(50).defense(200)
		...
		new Monster.MonsterFactory()
				...
				.health(75).attack(100).defense(0)
		...
		new Monster.MonsterFactory()
				...
				.health(80).attack(40).defense(20)
		...
		new Monster.MonsterFactory()
				...
				.health(50).attack(10).defense(10)
		...
		new Monster.MonsterFactory()
				...
				.health(150).attack(60).defense(10)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(6000)
				.numTargets(1).effectCooldown(3)
				.effect(new Heal(100))
