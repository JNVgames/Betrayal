...
//				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(130).attack(63).defense(30)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(2100)
				.numTargets(1)
				.effect(new SkipTurn()).effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(120).attack(58).defense(53)
		...
		new Monster.MonsterFactory()
				...
				.health(230).attack(88).defense(36)
		...
		new Monster.MonsterFactory()
				...
				.goldReward(7500)
				.numTargets(1).effectCooldown(2)
				.effect(new AttackAndDefenseUp(30,15,8)).skillTextureName("monsterpowerup")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(58)
				...
				.health(200).attack(77).defense(18)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(7500)
				.numTargets(2).effectCooldown(3)
				.effect(new Heal(150))
