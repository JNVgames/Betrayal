...
public class ResourceLoader {
	...
	private void loadMonsterData() {
		...
		new Monster.MonsterFactory()
				...
				.health(55).attack(50).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(60).defense(13)
		...
		new Monster.MonsterFactory()
				...
				.health(100).attack(40).defense(0)
		...
		new Monster.MonsterFactory()
				...
				.health(50).attack(45).defense(10)
