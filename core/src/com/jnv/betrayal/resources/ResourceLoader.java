...
//				.build();
		...
		new Monster.MonsterFactory()
				...
				.health(81).attack(49).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(97).attack(87).defense(14)
		...
		new Monster.MonsterFactory()
				...
				.health(74).attack(46).defense(11)
		...
		new Monster.MonsterFactory()
				...
				.health(78).attack(50).defense(12)
		...
		new Monster.MonsterFactory()
				...
				.health(92).attack(47).defense(14)
		...
		new Monster.MonsterFactory()
				...
				.health(69).attack(69).defense(16)
		...
		new Monster.MonsterFactory()
				...
				.health(150).attack(56).defense(24)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(28).defense(34)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1900)
				.numTargets(1).effectCooldown(3)
