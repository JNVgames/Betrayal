...
public class ResourceLoader {
	...
	private void loadMonsterData() {
		...
		new Monster.MonsterFactory()
				...
				.health(4).attack(24).defense(200)
		...
		new Monster.MonsterFactory()
				...
				.health(126).attack(49).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(96).attack(50).defense(12)
		...
		new Monster.MonsterFactory()
				...
				.health(102).attack(47).defense(14)
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(47).defense(13)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1000)
				.numTargets(4).effectCooldown(3)
				.effect(new DefenseDown(40, 3)).effectCooldown(4).skillTextureName("monstershieldbreak")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(18)
		...
		new Monster.MonsterFactory()
				...
				.health(76).attack(69).defense(16)
		...
		new Monster.MonsterFactory()
				...
				.effect(new Bomb(80,2)).skillTextureName("monsterbomb")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(21)
				...
				.health(80).attack(54).defense(10)
				.textureWidth(400).textureHeight(500).x(160).y(670)
				.goldReward(900)
				.numTargets(4)
		...
		new Monster.MonsterFactory()
				...
				.health(55).attack(56).defense(13)
		...
		new Monster.MonsterFactory()
				...
				.health(130).attack(73).defense(17)
		...
		new Monster.MonsterFactory()
				...
				.health(110).attack(56).defense(30)
		...
		new Monster.MonsterFactory()
				...
				.health(150).attack(86).defense(24)
		...
		new Monster.MonsterFactory()
				...
				.health(180).attack(73).defense(30)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(2100)
				.numTargets(1)
				.effect(new SkipTurn()).effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(170).attack(47).defense(28)
		...
		new Monster.MonsterFactory()
				...
				.health(140).attack(43).defense(3)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3200)
				.effect(new AttackAndDefenseUp(10,5,9)).skillTextureName("monsterpowerup")
				.numTargets(1).effectCooldown(2)
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				...
				.health(160).attack(73).defense(17)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3300)
				.numTargets(1).effectCooldown(3)
		...
		new Monster.MonsterFactory()
				...
				.health(180).attack(81).defense(23)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3700)
				.numTargets(1).effectCooldown(3)
				.effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(72).attack(61).defense(18)
		...
		new Monster.MonsterFactory()
				...
				.health(73).attack(66).defense(12)
		...
		new Monster.MonsterFactory()
				...
				.health(65).attack(58).defense(24)
		...
		new Monster.MonsterFactory()
				...
				.health(10).attack(71).defense(400)
		...
		new Monster.MonsterFactory()
				...
				.health(60).attack(72).defense(40)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(64).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(65).defense(13)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(71).defense(21)
		...
		new Monster.MonsterFactory()
				...
				.health(40).attack(62).defense(13)
		...
		new Monster.MonsterFactory()
				...
				.health(120).attack(68).defense(53)
		...
		new Monster.MonsterFactory()
				...
				.health(200).attack(88).defense(16)
				.textureWidth(450).textureHeight(550).x(135).y(665)
				.goldReward(7500)
				.numTargets(1).effectCooldown(3)
				.effect(new IncreasedAttack(140)).skillTextureName("monsterincreasedattack")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(56)
				...
				.health(212).attack(92).defense(27)
				.textureWidth(620).textureHeight(500).x(50).y(640)
				.goldReward(7500)
				.numTargets(1).effectCooldown(4)
				.effect(new AttackUp(40,3)).skillTextureName("monstermelee")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(57)
				...
				.health(210).attack(20).defense(0)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(7500)
				.numTargets(1).effectCooldown(2)
				.effect(new AttackAndDefenseUp(20,10,50)).skillTextureName("monsterpowerup")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(58)
				...
				.health(275).attack(77).defense(18)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(7500)
				.numTargets(2).effectCooldown(3)
				.effect(new Heal(150))
		...
		new Monster.MonsterFactory()
				...
				.health(170).attack(87).defense(38)
				.textureWidth(500).textureHeight(500).x(110).y(665)
				.goldReward(7500)
				.numTargets(1).effectCooldown(3)
				.effect(new TrueDamage(60)).skillTextureName("monstermelee").effectCooldown(3)
				.build();
	}
}
