...
public class ResourceLoader {
	...
	private void loadMonsterData() {
		...
		new Monster.MonsterFactory()
				...
				.health(60).attack(40).defense(10)
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(40).defense(15)
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(40).defense(10)
		...
		new Monster.MonsterFactory()
				...
				.health(65).attack(50).defense(20)
		...
		new Monster.MonsterFactory()
				...
				.health(80).attack(20).defense(30)
		...
		new Monster.MonsterFactory()
				...
				.health(70).attack(60).defense(20)
