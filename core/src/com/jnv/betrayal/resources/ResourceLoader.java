...
public class ResourceLoader {
	...
	private void loadMonsterData() {
		...
		new Monster.MonsterFactory()
				...
				.health(16).attack(69).defense(69)
		...
		new Monster.MonsterFactory()
				...
				.health(25).attack(60).defense(0)
				.textureWidth(400).textureHeight(500).x(160).y(670)
				.goldReward(600)
				.numTargets(1).effectCooldown(2)
				.effect(new Bomb(50,2)).skillTextureName("monsterbomb")
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				.id(21)
				...
				.health(40).attack(44).defense(10)
				.textureWidth(400).textureHeight(500).x(160).y(670)
				.goldReward(900)
				.numTargets(2).effectCooldown(3)
		...
		new Monster.MonsterFactory()
				...
				.health(28).attack(57).defense(20)
		...
		new Monster.MonsterFactory()
				...
				.health(25).attack(75).defense(50)
				.textureWidth(500).textureHeight(500).x(110).y(670)
				.goldReward(1200)
				.numTargets(1)
				.effect(new SkipTurn()).effectCooldown(2)
		...
		new Monster.MonsterFactory()
				...
				.health(120).attack(10).defense(6)
		...
		new Monster.MonsterFactory()
				...
				.health(80).attack(80).defense(12)
		...
		new Monster.MonsterFactory()
				...
				.health(80).attack(10).defense(5)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(2900)
				.effect(new AttackAndDefenseUp(10,5,10)).skillTextureName("monsterpowerup")
				.numTargets(1).effectCooldown(2)
				.build();
		new Monster.MonsterFactory()
				.assetManager(res)
				...
				.health(72).attack(64).defense(17)
				.textureWidth(500).textureHeight(475).x(110).y(665)
				.goldReward(3200)
				.numTargets(1).effectCooldown(3)
		...
		new Monster.MonsterFactory()
				...
				.health(20).attack(47).defense(400)
		...
		new Monster.MonsterFactory()
				...
				.health(20).attack(62).defense(40)
