...
package com.jnv.betrayal.inputprocessors;
...
public class BetrayalGestureProcessor implements GestureDetector.GestureListener {
	...
	public boolean touchDown(float x, float y, int pointer, int button) {
		initialScale = BetrayalInput.zoom;
		return false;
	}

	public boolean tap(float x, float y, int count, int button) {
		BetrayalInput.isTapped = true;
		return false;
	}
	...
	public boolean fling(float velocityX, float velocityY, int button) {
		if (Math.abs(velocityX) > Math.abs(velocityY)) {
			if (velocityX > 0) {
				BetrayalInput.rightFling = true;
			} else {
				BetrayalInput.leftFling = true;
			}
		} else {
			if (velocityY > 0) {
				BetrayalInput.downFling = true;
			} else {
				BetrayalInput.upFling = true;
			}
		}
	...
	public boolean pan(float x, float y, float deltaX, float deltaY) {
		if (deltaX < 0) {
			BetrayalInput.pannedRight = true;
			BetrayalInput.deltaX = deltaX;
		}

		if (deltaX > 0) {
			BetrayalInput.pannedLeft = true;
			BetrayalInput.deltaX = deltaX;
		}

		if (deltaY < 0) {
			BetrayalInput.pannedUp = true;
			BetrayalInput.deltaY = deltaY;
		}

		if (deltaY > 0) {
			BetrayalInput.pannedDown = true;
			BetrayalInput.deltaY = deltaY;
		}
	...
	public boolean pinch(Vector2 initialPointer1, Vector2 initialPointer2, Vector2 pointer1, Vector2 pointer2) {
		BetrayalInput.deltaX2 = pointer1.x - initialPointer1.x;
		BetrayalInput.deltaY2 = pointer1.y - initialPointer1.y;
		BetrayalInput.isPanned = true;
		return true;
	}
